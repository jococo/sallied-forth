d3 = function() {
    ...
    function ot(n, t, e) {
        ...
        var r = nt((.4124564 * n + .3575761 * t + .1804375 * e) / Ra), i = nt((.2126729 * n + .7151522 * t + .072175 * e) / Oa), u = nt((.0193339 * n + .119192 * t + .9503041 * e) / Ya);
    ...
    function Dt() {
        function n(n, i) {
            n*=La;
            var u = Math.cos(i*=La), a = u * Math.cos(n), o = u * Math.sin(n), c = Math.sin(i), l = Math.atan2(Math.sqrt((l = e * c - r * o) * l + (l = r * a - t * c) * l + (l = t * o - e * a) * l), t * a + e * o + r * c);
    ...
    function Pt(n, t, e) {
        return function(r) {
            ...
            function f() {
                ...
                var n, t = M.clean(), e = y.buffer(), i = e.length;
                if (!i)
                    return p=!0, g += Yt(d, -1), d = null, void 0;
                if (d = null, 1 & t) {
                    n = e[0], h += Yt(n, 1);
                    var u, i = n.length-1, a =- 1;
                    for (r.lineStart(); ++a < i;)
                        r.point((u = n[a])[0], u[1]);
    ...
    function It(n) {
        ...
        return {
            ...
            point: function(u, a) {
                var o = u > 0 ? Da: - Da, c = Math.abs(u - e);
    ...
    function Xt(n, t, e, r) {
        var i;
        if (null == n)
            i = e * Da / 2, r.point( - Da, i), r.point(0, i), r.point(Da, i), r.point(Da, 0), r.point(Da, - i), r.point(0, - i), r.point( - Da, - i), r.point( - Da, 0), r.point( - Da, i);
    ...
    function Zt(n) {
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(s, h) {
                    var g, p = [s, h], d = t(s, h), m = a ? d ? 0: i(s, h): d ? i(s + (0 > s ? Da : - Da), h): 0;
                    if (!e && (l = c = d) && n.lineStart(), d !== c && (g = r(e, p)
                        , (Tt(e, g) || Tt(p, g)) && (p[0] += ja, p[1] += ja, d = t(p[0], p[1]))), d !== c)f = 0, d ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g;
                    else if (o && e && a^d) {
                        var v;
        ...
        function r(n, t, e) {
            var r = wt(n), i = wt(t), a = [1, 0, 0], o = Et(r, i), c = St(o, o), l = o[0], f = c - l * l;
            if (!f)
                return !e && n;
            var s = u * c / f, h =- u * l / f, g = Et(a, o), p = At(a, s), d = At(o, h);
            kt(p, d);
            var m = g, v = St(p, m), y = St(m, m), M = v * v - y * (St(p, p)-1);
            if (!(0 > M)) {
                var x = Math.sqrt(M), b = At(m, ( - v - x) / y);
                if (kt(b, p), b = qt(b)
                    , !e)return b;
                var _, w = n[0], S = t[0], E = n[1], k = t[1];
                w > S && (_ = w, w = S, S = _);
                var A = S - w, N = Math.abs(A - Da) < ja, q = N || ja > A;
        ...
        var u = Math.cos(n), a = u > 0, o = Math.abs(u) > ja, c = ue(n, 6 * La);
        return Pt(t, e, c)
    }
    function Bt(n, t, e, r) {
        function i(r, i) {
        ...
        return function(c) {
            ...
            function v(n, t) {
                ...
                var e = g(n, t);
                if (M && x.push([n, t]), N)
                    _ = n, w = t, S = e, N=!1, e && (c.lineStart(), c.point(n, t));
                else if (e && A)
                    c.point(n, t);
                else {
                    var r = [E, k], i = [n, t];
            ...
            var y, M, x, _, w, S, E, k, A, N, q = c, T = Ot(), C = {
                point: p,
                lineStart: d,
                lineEnd: m,
                polygonStart: function() {
    ...
    function Gt(n) {
        ...
        function e(t, i, u, a, o, c, l, f, s, h, g, p, d, m) {
            ...
            if (M > 4 * r && d--) {
                var x = a + h, b = o + g, _ = c + p, w = Math.sqrt(x * x + b * b + _ * _), S = Math.asin(_/=w), E = Math.abs(Math.abs(_)-1) < ja ? (u + s) / 2: Math.atan2(b, x), k = n(E, S), A = k[0], N = k[1], q = A - t, T = N - i, C = y * q - v * T;
    ...
    function Wt(n) {
        ...
        }), f = 150, s = 480, h = 250, g = 0, p = 0, d = 0, m = 0, v = 0, y = vo, M = st, x = null, b = null;
    ...
    function he() {
        function n(n, i) {
            var u = Math.sin(i*=La), a = Math.cos(i), o = Math.abs((n*=La) - t), c = Math.cos(o);
    ...
    function ke(n, t) {
        ...
        return u ? (e.invert = function(n, t) {
            var e = a - t, r = O(u) * Math.sqrt(n * n + e * e);
    ...
    function qe(n) {
        var t, e = Kt(n), r = e.scale, i = e.translate, u = e.clipExtent;
    ...
    function Ge(n) {
        for (var t = 0, e = n.length-1, r = [], i = n[0], u = n[1], a = r[0] = Je(i, u);
        ++t < e;
        ...
        var e = {
            ...
            rightOf: function(n, t) {
                ...
                if (e.a === 1) {
                    ...
                    if (!i && e.b < 0 || i && e.b >= 0 ? c = o = u >= e.b * a : (c = t.x + t.y * e.b > e.c, e.b < 0 && (c=!c), c || (o = 1)
                        ), !o) {
    ...
    function cr(n) {
        var t = [n.a, n.b], e = [n.c, n.d], r = fr(t), i = lr(t, e), u = fr(sr(e, t, - i)) || 0;
    ...
    function gr(n, t) {
        var e, r = [], i = [], u = ua.transform(n), a = ua.transform(t), o = u.translate, c = a.translate, l = u.rotate, f = a.rotate, s = u.skew, h = a.skew, g = u.scale, p = a.scale;
        return o[0] != c[0] || o[1] != c[1] ? (r.push("translate(", null, ",", null, ")"), i.push({
            ...
            i : r.push(r.pop() + "rotate(", null, ")")-2, x : hr(l, f)
    ...
    function dr(n, t) {
        ...
        for (n += "", t += "", Yo.lastIndex = 0, r = 0; e = Yo.exec(t);
        ++r)e.index && l.push(t.substring(o, c = e.index)), f.push({
            i: l.length,
            x: e[0]
        }), l.push(null), o = Yo.lastIndex;
        for (o < t.length && l.push(t.substring(o)), r = 0, u = f.length; (e = Yo.exec(n)
            ) && u > r;
        ++r)if (a = f[r], a.x == e[0]) {
            if (a.i)
                if (l[a.i + 1] == null)
            ...
            a.x = hr(parseFloat(e[0]), parseFloat(a.x));
        for (; u > r;)
    ...
    function wi(n) {
        ...
        if ((e = n.children) && (l = e.length)) {
            ...
            if (e.forEach(Si), r = e[0], r.x =- r.r, r.y = 0, t(r)
                , l > 1 && (i = e[1], i.x = i.r, i.y = 0, t(i), l > 2))for (u = e[2], Ai(r, i, u)
                , t(u), xi(r, u), r._pack_prev = u, xi(u, i), i = r._pack_next, a = 3;
            l > a;
            a++) {
                Ai(r, i, u = e[a]);
                var p = 0, d = 1, m = 1;
    ...
    function Ri(n, t, e, r) {
        function i() {
            var i = Math.min(n.length, t.length) > 2 ? Pi: Fi, c = r ? Hr: Fr;
    ...
    function Ui(n, t) {
        var e = ji(n), r = e[1] - e[0], i = Math.pow(10, Math.floor(Math.log(r / t) / Math.LN10)), u = t / r * i;
    ...
    function Xi(n, t, e, r, i) {
        ...
        return u.invert = function(t) {
            ...
            if (arguments.length < 2 && (i = Go), !arguments.length)
                return i;
            var a, o = Math.log(t), c = Math.max(.1, n / u.ticks().length), l = e === $i ? (a =- 1e-12, Math.floor) : (a = 1e-12, Math.ceil);
            return function(n) {
    ...
    function Qi(n, t) {
        function e() {
            ...
            for (i = [];
            ++e < u;
            )i[e-1] = ua.quantile(n, e / u); return r
        }
        function r(n) {
    ...
    function cu(n) {
        function t(t) {
            ...
            for (var h, g, p, d = [], m = [], v = [], y =- 1, M = t.length, x = ft(e)
                , b = ft(i), _ = e === r ? function() {
                return g
            } : ft(r), w = i === u ? function() {
                return p
            } : ft(u);
        ...
        var e = ze, r = ze, i = 0, u = De, a = Lt, o = je, c = o.key, l = o, f = "L", s = .7;
        return t.x = function(n) {
    ...
    function su(n) {
        return function() {
            var t = n.apply(this, arguments), e = t[0], r = t[1] + tc;
    ...
    function bu(n, t, e) {
        if (r = [], e && t.length > 1) {
            for (var r, i, u, a = ji(n.domain()), o =- 1, c = t.length, l = (t[1] - t[0])
                /++e;
            ++o < c;
            )for (i = e; --i > 0;)(u =+ t[o] - i * l)
                >= a[0] && r.push(u);
            for (--o, i = 0; ++i < e && (u =+ t[o] + i * l)
                < a[1];
            )r.push(u)
        }
        return r
    ...
    function Eu(n, t, e, r) {
        for (var i, u, a = 0, o = t.length, c = e.length; o > a;) {
            ...
            if (i = t.charCodeAt(a++), 37 === i) {
                if (u = zc[t.charAt(a++)], !u || (r = u(n, e, r)
                    ) < 0)return -1
    ...
    function $u(n, t, e) {
        ...
        return r.invert = function(t) {
            ...
            if ("function" != typeof e) {
                var a = u[1] - u[0], o = a / e, c = ua.bisect(Fc, o);
                if (c == Fc.length)
                    return t.year(u, e);
                if (!c)
                    return n.ticks(e).map(Ju);
    ...
    function Wu(n) {
        var t = n.getFullYear(), e = Ku(t), r = Ku(t + 1);
        return t + (n - e) / (r - e)
    }
    function Qu(n) {
    ...
    function na(n) {
        var t = n.getUTCFullYear(), e = Qu(t), r = Qu(t + 1);
        return t + (n - e) / (r - e)
    }
    function ta(n) {
    ...
    var aa = document, oa = window;
    try {
        aa.createElement("div").style.setProperty("opacity", 0, "")
    } catch (ca) {
        var la = oa.CSSStyleDeclaration.prototype, fa = la.setProperty;
    ...
    ua.ascending = function(n, t) {
        ...
        if (arguments.length === 1) {
            for (; ++u < a && ((e = i = n[u]) == null || e != e);)
                e = i = void 0;
            for (; ++u < a;)(r = n[u])
                != null && (e > r && (e = r), r > i && (i = r))
        } else {
            for (; ++u < a && ((e = i = t.call(n, n[u], u)) == null || e != e);)
                e = void 0;
            for (; ++u < a;)(r = t.call(n, n[u], u)
                ) != null && (e > r && (e = r), r > i && (i = r))
        }
        return [e, i]
    }, ua.sum = function(n, t) {
        ...
        return {
            left: function(t, e, r, i) {
                for (arguments.length < 3 && (r = 0), arguments.length < 4 && (i = t.length);
                i > r;
                ) {
                    var u = r + i>>>1;
    ...
    ua.bisectLeft = sa.left, ua.bisect = ua.bisectRight = sa.right, ua.shuffle = function(n) {
        ...
        if (!(i = arguments.length))
            return [];
        for (var n =- 1, e = ua.min(arguments, t)
            , r = Array(e);
        ++n < e;
        )for (var i, u =- 1, a = r[n] = Array(i);
        ++u < i;
        )a[u] = arguments[u][n];
        return r
        ...
        if (arguments.length < 3 && (r = 1, arguments.length < 2 && (t = n, n = 0))
            , 1 / 0 === (t - n) / r)throw Error("infinite range");
    ...
    ua.nest = function() {
        function n(t, o, c) {
            ...
            for (var l, f, s, h, g =- 1, p = o.length, d = a[c++], m = new i; ++g < p;)(h = m.get(l = d(f = o[g]))
                ) ? h.push(f) : m.set(l, [f]);
        ...
        var e = n.indexOf("."), r = "";
        if (e >= 0 && (r = n.substring(e + 1), n = n.substring(0, e))
            , n)return arguments.length < 2 ? this[n].on(r) : this[n].on(r, t);
    ...
    var pa = /WebKit/.test(oa.navigator.userAgent)?-1 : 0, da = d;
    try {
    ...
    ua.touches = function(n, t) {
        ...
        function t() {
            ...
            var u, a = this, o = e.of(a, arguments), c = ua.event.target, f = ua.event.touches ? ua.event.changedTouches[0].identifier: null, h = n(), g = 0, p = ua.select(oa).on(null != f ? "touchmove.drag-" + f : "mousemove.drag", t).on(null != f ? "touchend.drag-" + f : "mouseup.drag", i, !0);
    ...
    }, xa = aa.documentElement, ba = xa.matchesSelector || xa.webkitMatchesSelector || xa.mozMatchesSelector || xa.msMatchesSelector || xa.oMatchesSelector, _a = function(n, t) {
        return ba.call(n, t)
    };
    ...
    wa.select = function(n) {
        ...
        for (var a =- 1, o = this.length; ++a < o;) {
            ...
            for (var c =- 1, l = r.length; ++c < l;)(i = r[c])
                ? (t.push(e = n.call(i, i.__data__, c)), e && "__data__"in i && (e.__data__ = i.__data__)) : t.push(null)
        }
        return m(u)
        ...
        for (var i =- 1, u = this.length; ++i < u;)
            for (var a = this[i], o =- 1, c = a.length; ++o < c;)(e = a[o])
                && (r.push(t = da(n.call(e, e.__data__, o))), t.parentNode = e);
        return m(r)
    };
    var Sa = {
    ...
    wa.classed = function(n, t) {
        ...
        if (!arguments.length) {
            for (n = Array(o = (r = this[0]).length); ++a < o;)(u = r[a])
                && (n[a] = u.__data__);
            return n
        }
        var c = L([]), l = m([]), f = m([]);
    ...
    ua.selection.enter = L, ua.selection.enter.prototype = Aa, Aa.append = wa.append, Aa.insert = wa.insert, Aa.empty = wa.empty, Aa.node = wa.node, Aa.select = function(n) {
        for (var t, e, r, i, u, a = [], o =- 1, c = this.length; ++o < c;) {
            ...
            for (var l =- 1, f = i.length; ++l < f;)(u = i[l])
                ? (t.push(r[l] = e = n.call(i.parentNode, u.__data__, l)), e.__data__ = u.__data__) : t.push(null)
        }
        return m(a)
    }, wa.transition = function() {
        var n, t, e = ic||++cc, r = [], i = Object.create(lc);
        i.time = Date.now();
    ...
    ua.behavior.zoom = function() {
        ...
        function o() {
            ...
            var r = this, u = k.of(r, arguments), o = ua.event.target, c = 0, f = ua.select(oa).on("mousemove.zoom", n).on("mouseup.zoom", e), h = t(ua.mouse(r));
            oa.focus(), l()
        }
        function c() {
        ...
        function d() {
            var n = ua.touches(this), t = n[0], e = m[t.identifier];
            if (u = n[1]) {
        ...
        var m, v, y, M, x, b, _, w = [0, 0], S = 1, E = Ta, k = h(n, "zoom");
    ...
    var qa, Ta = [0, 1 / 0], Ca = "onwheel"in aa ? (qa = function() {
    ...
    var Da = Math.PI, ja = 1e-6, La = Da / 180, Fa = 180 / Da;
    ...
    var Pa = 18, Ra = .95047, Oa = 1, Ya = 1.08883, Ua = G.prototype = new F;
    ...
    Va.forEach(function(n, t) {
        ...
        var i = {}, u = ua.dispatch("progress", "load", "error"), a = {}, o = st, c = new (oa.XDomainRequest && /^(http(s)?:)?\/\//.test(n) ? XDomainRequest : XMLHttpRequest);
        return "onload"in c ? c.onload = c.onerror = r : c.onreadystatechange = function() {
            ...
            if (arguments.length === 2 && "function" == typeof r && (u = r, r = null), c.open(e, n, !0)
                , null == t || "accept"in a || (a.accept = t + ",*/*"), c.setRequestHeader)for (var o in a)
    ...
    var Ga = oa.requestAnimationFrame || oa.webkitRequestAnimationFrame || oa.mozRequestAnimationFrame || oa.oRequestAnimationFrame || oa.msRequestAnimationFrame || function(n) {
        setTimeout(n, 17)
    }, Ka = ".", Wa = ",", Qa = [3, 3], no = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(mt);
    ua.formatPrefix = function(n, t) {
        ...
        var t = to.exec(n), e = t[1] || " ", r = t[2] || ">", i = t[3] || "", u = t[4] || "", a = t[5], o =+ t[6], c = t[7], l = t[8], f = t[9], s = 1, h = "", g=!1;
    ...
    ua.geo.bounds = function() {
        ...
        function t(t, e) {
            var r = wt([t * La, e * La]);
            if (v) {
                var i = Et(v, r), u = [i[1], - i[0], 0], a = Et(u, i);
                Nt(a), a = qt(a);
                var c = t - p, l = c > 0 ? 1: -1, d = a[0] * Fa * l, m = Math.abs(c) > 180;
                if (m^(d > l * p && l * t > d)) {
                    var y = a[1] * Fa;
                    y > g && (g = y)
    ...
    ua.geo.projection = Kt, ua.geo.projectionMutator = Wt, (ua.geo.equirectangular = function() {
        ...
        function n() {
            var n = "function" == typeof r ? r.apply(this, arguments): r, t = te( - n[0] * La, - n[1] * La, 0).invert, i = [];
        ...
        var e, r = (t[0] - n[0]) * La, i = n[1] * La, u = t[1] * La, a = Math.sin(r), o = Math.cos(r), c = Math.sin(i), l = Math.cos(i), f = Math.sin(u), s = Math.cos(u);
    ...
    (ua.geo.conicEqualArea = function() {
        ...
        var t, e, r, i, u = ua.geo.albers(), a = ua.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), o = ua.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), c = {
            point: function(n, e) {
                t = [n, e]
            }
        };
    ...
    var Fo = [0, 2 / 3, 1 / 3, 0], Ho = [0, 1 / 3, 2 / 3, 0], Po = [0, 1 / 6, 2 / 3, 1 / 6];
    ua.geom.hull = function(n) {
        ...
        return n.area = function() {
            ...
            for (var e, r, i, u, a, o, c =- 1, l = n.length, f = n[l-1]; ++c < l;) {
                for (e = t.slice(), t.length = 0, u = n[c], a = e[(i = e.length)
                    -1], r =- 1;
                ++r < i;
        ...
        function t(n) {
            var t, r, a, o = n.map(function() {
                return []
            }), c = ft(i), l = ft(u), f = n.length, s = 1e6;
            if (c === ze && l === De)
                t = n;
            else
                for (t = [], a = 0;
                f > a;
                ++a)t.push([ + c.call(this, r = n[a], a)
                    , + l.call(this, r, a)]);
            if (er(t, function(n) {
                var t, e, r, i, u, a;
        ...
        return arguments.length ? t(n) : (t.x = function(n) {
            ...
            return er(t, function(t) {
                ...
                a[e][r] || (a[e][r] = a[r][e]=!0, o.push({
                    source : n[e], target : n[r]
                }))
            }), o
        }, t.triangles = function(n) {
            if (i === ze && u === De)
                return ua.geom.delaunay(n);
            var t, e, r, a, o, c = ft(i), l = ft(u);
    ...
    ua.ease = function(n) {
        ...
        function n() {
            var n, l, s, h, g, p = {}, d = [], m = ua.range(u), v = [];
            for (e = [], r = [], n = 0, h =- 1; ++h < u;) {
                for (l = 0, g =- 1; ++g < u;)
                    l += i[h][g];
        ...
        var e, r, i, u, a, o = {}, c = ua.dispatch("start", "tick", "end"), l = [1, 1], f = .9, s = Xo, h = Zo, g =- 30, p = .1, d = .8, m = [], v = [];
        return o.tick = function() {
            ...
            if (g)
                for (Xr(t = ua.geom.quadtree(m), r, a)
                    , e =- 1;
            ++e < b;
    ...
    ua.layout.hierarchy = function() {
        ...
        var r = ua.layout.hierarchy(), i = [1, 1];
        ...
        function n(u) {
            var a = u.map(function(e, r) {
                return + t.call(n, e, r)
            }), o =+ ("function" == typeof r ? r.apply(this, arguments) : r), c = (("function" == typeof i ? i.apply(this, arguments) : i) - o) / ua.sum(a), l = ua.range(u.length);
    ...
    ua.layout.stack = function() {
        ...
        var t = st, e = ni, r = ti, i = Qr, u = Kr, a = Wr;
    ...
    var $o = ua.map({
        "inside-out": function(n) {
            var t, e, r = n.length, i = n.map(ei), u = n.map(ri), a = ua.range(r).sort(function(n, t) {
                return i[n] - i[t]
            }), o = 0, c = 0, l = [], f = [];
            for (t = 0; r > t; ++t)
    ...
    ua.layout.histogram = function() {
        ...
        function n(n, i) {
            ...
            function o(n, t, r) {
                if (t) {
                    for (var i, u = n, a = n, o = t, c = n.parent.children[0], l = u._tree.mod, f = a._tree.mod, s = o._tree.mod, h = c._tree.mod; o = fi(o), u = li(u)
                        , o && u;
            ...
            var f = si(l, gi), s = si(l, hi), h = si(l, pi), g = f.x - e(f, s) / 2, p = s.x + e(s, f) / 2, d = h.depth || 1;
            return di(l, function(n) {
                n.x = (n.x - g) / (p - g) * r[0], n.y = n.depth / d * r[1], delete n._tree
            }), c
        }
        var t = ua.layout.hierarchy().sort(null).value(null), e = ci, r = [1, 1];
        ...
        var t = ua.layout.hierarchy().sort(Mi), e = 0, r = [1, 1];
        ...
        function n(n, i) {
            var u, a = t.call(this, n, i), o = a[0], c = 0;
            di(o, function(n) {
                var t = n.children;
                t && t.length ? (n.x = qi(t), n.y = Ni(t)) : (n.x = u ? c += e(n, u) : 0, n.y = 0, u = n)
            });
            var l = Ti(o), f = Ci(o), s = l.x - e(l, f) / 2, h = f.x + e(f, l) / 2;
        ...
        var a, o = ua.layout.hierarchy(), c = Math.round, l = [1, 1], f = null, s = zi, h=!1, g = "squarify", p = .5 * (1 + Math.sqrt(5));
    ...
    ua.scale.quantile = function() {
        ...
        function n() {
            var n = t.apply(this, arguments), u = e.apply(this, arguments), a = r.apply(this, arguments) + tc, o = i.apply(this, arguments) + tc, c = (a > o && (c = a, a = o, o = c), o - a), l = Da > c ? "0": "1", f = Math.cos(a), s = Math.sin(a), h = Math.cos(o), g = Math.sin(o);
        ...
        return n.innerRadius = function(e) {
            ...
            var n = (t.apply(this, arguments) + e.apply(this, arguments)) / 2, u = (r.apply(this, arguments) + i.apply(this, arguments)) / 2 + tc;
            return [Math.cos(u) * n, Math.sin(u) * n]
        }, n
    };
    var tc =- Da / 2, ec = 2 * Da-1e-6;
    ua.svg.line.radial = function() {
        ...
        function t(n, t, e, r) {
            var i = t.call(n, e, r), u = o.call(n, i, r), a = c.call(n, i, r) + tc, f = l.call(n, i, r) + tc;
            return {
                r: u,
                a0: a,
                a1: f,
        ...
        var n = ua.svg.diagonal(), t = fu, e = n.projection;
    ...
    var ic, uc = Math.sqrt(3), ac = Math.tan(30 * La), oc = [], cc = 0, lc = {
        ease: Sr,
        delay: 0,
        duration: 250
    };
    oc.call = wa.call, oc.empty = wa.empty, oc.node = wa.node, ua.transition = function(n) {
        ...
        for (var a =- 1, o = this.length; ++a < o;) {
            u.push(t = []);
            for (var c = this[a], l =- 1, f = c.length; ++l < f;)(r = c[l])
                && (e = n.call(r, r.__data__, l)) ? ("__data__"in r && (e.__data__ = r.__data__), yu(e, l, i, r.__transition__[i]), t.push(e)) : t.push(null)
        }
        return du(u, i)
        ...
        for (var n, t, e, r, i = this.id, u=++cc, a = [], o = 0, c = this.length; c > o; o++) {
            a.push(n = []);
            for (var t = this[o], l = 0, f = t.length; f > l; l++)(e = t[l])
                && (r = Object.create(e.__transition__[i]), r.delay += r.duration, yu(e, l, u, r)), n.push(e)
        }
        return du(a, u)
        ...
        var t, e = ua.scale.linear(), r = fc, i = 6, u = 6, a = 6, o = 3, c = [10], l = null, f = 0;
    ...
    ua.svg.brush = function() {
        function n(u) {
            u.each(function() {
                var u, a = ua.select(this), l = a.selectAll(".background").data([0]), s = a.selectAll(".extent").data([0]), h = a.selectAll(".resize").data(f, String);
        ...
        function i() {
            ...
            function g() {
                ...
                v && (n[0] += v[0], n[1] += v[1]), E || (ua.event.altKey ? (m || (m = [(s[0][0] + s[1][0]) / 2, (s[0][1] + s[1][1]) / 2]), k[0] = s[ + (n[0] < m[0])][0], k[1] = s[ + (n[1] < m[1])][1]) : m = null), w && p(n, o, 0) && (e(b), u=!0), S && p(n, c, 1) && (r(b), u=!0), u && (t(b), x({
                    type : "brush", mode : E ? "move" : "resize"
                }))
            }
            function p(n, t, e) {
                var r, i, a = Li(t), o = a[0], c = a[1], l = k[e], f = s[1][e] - s[0][e];
            ...
            var m, v, y = this, M = ua.select(ua.event.target), x = a.of(y, arguments), b = ua.select(y), _ = M.datum(), w=!/^(n|s)$/.test(_) && o, S=!/^(e|w)$/.test(_) && c, E = M.classed("extent"), k = i(), A = ua.select(oa).on("mousemove.brush", g).on("mouseup.brush", d).on("touchmove.brush", g).on("touchend.brush", d).on("keydown.brush", f).on("keyup.brush", h);
            if (E)
                k[0] = s[0][0] - k[0], k[1] = s[0][1] - k[1];
            else if (_) {
                var N =+ /w$/.test(_), q =+ /^n/.test(_);
                v = [s[1 - N][0] - k[0], s[1 - q][1] - k[1]], k[0] = s[N][0], k[1] = s[q][1]
            } else
                ua.event.altKey && (m = k.slice());
            b.style("pointer-events", "none").selectAll(".resize").style("display", null), ua.select("body").style("cursor", M.style("cursor")), x({
                type: "brushstart"
            }), g(), l()
        }
        var u, a = h(n, "brushstart", "brush", "brushend"), o = null, c = null, f = gc[0], s = [[0, 0], [0, 0]];
    ...
    ua.time = {};
    var pc = Date, dc = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
    _u.prototype = {
        getDate: function() {
    ...
    var mc = Date.prototype, vc = "%a %b %e %X %Y", yc = "%m/%d/%Y", Mc = "%H:%M:%S", xc = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], bc = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], _c = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], wc = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    ...
    var Sc = ku(xc), Ec = ku(bc), kc = ku(_c), Ac = Au(_c), Nc = ku(wc), qc = Au(wc), Tc = {
        "-": "",
        _: " ",
        0: "0"
    }, Cc = {
